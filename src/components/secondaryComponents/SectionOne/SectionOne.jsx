    ...
    <>
      <div id='section-one-container' className='section-one-container'>
        ...
        <div id='section-one' className='section-one'>
          ...
          <h1 id='myself'>I have passion for creating dynamic and responsive web applications. I have experience in both front-end and back-end development, and I am always eager to learn new technologies and improve my skills. Let's build something amazing together!</h1>
          </div>
        </div>
